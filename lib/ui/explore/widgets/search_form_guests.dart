...
const String removeGuestsKey = 'remove-students';
const String addGuestsKey = 'add-students';

/// Number of students selection form
///
        ...
        children: [
          ...
          ListenableBuilder(
            ...
            builder: (context, _) => Text(
              viewModel.students.toString(),
              style: viewModel.students == 0
