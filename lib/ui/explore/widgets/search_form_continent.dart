...
///
/// Loads a list of fields in a horizontal carousel.
          ...
          if (viewModel.load.error) {
            return Center(
              child: ErrorIndicator(
                title: AppLocalization.of(context).errorWhileLoadingFields,
          ...
          builder: (context, child) {
            return ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                final Field(:imageUrl, :name) = viewModel.fields[index];
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            // Overlay when other field is selected
            Positioned.fill(
            ...
            Positioned.fill(
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    if (viewModel.selectedField == name) {
                      viewModel.selectedField = null;
                    } else {
                      viewModel.selectedField = name;
                    }
